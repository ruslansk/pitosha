...
class MyBuildExt(build_ext):
    ...
    def build_extension(self, ext):
        if self.amalgamation:
            ...
            ext.extra_link_args.append(os.path.join(AMALGAMATION_ROOT, "ssleay32MT.lib"))
            ext.extra_link_args.append(os.path.join(AMALGAMATION_ROOT, "libeay32MT.lib"))
            ext.extra_link_args.append("advapi32.lib")
            ext.extra_link_args.append("gdi32.lib")
            ext.extra_link_args.append("shell32.lib")
